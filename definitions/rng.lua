...
--- @param max integer
--- @return integer
function Rng:int_i(min, max) end
...
--- @param max integer
--- @return integer
function Rng:int_skip(min, skip, max) end
...
--- @param max integer
--- @return integer
function Rng:int_bias_low(min, max) end
...
--- @param max number
--- @return number
function Rng:normal(min, max) end
